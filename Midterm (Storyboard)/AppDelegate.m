...
//    signupVC.dummyDataManager = self.dummyDataManager;
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "VivianeChan.Midterm__Storyboard_" in the application's documents directory.
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Midterm__Storyboard_.sqlite"];
    NSError *error = nil;
